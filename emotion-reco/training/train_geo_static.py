...
_LOWER_JAW = [152, 175, 199, 200, 18, 83, 313, 421, 396, 369]
...
def main(args):
    ...
    # and pair list next to the state_dict, which PyTorch 2.6+ refuses to
    # unpickle by default.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default="runs/geo_static",
                        help="Output folder (default: runs/geo_static)")
    ...
    parser.add_argument("--dropout",  type=float, default=0.5,
                        help="Higher than the other trainers since the "
                             "geo-feature MLP overfits faster on AffectNet")
