...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data", default="../facemesh_dataset",
        help="Folder containing the .npz files (default: ../facemesh_dataset)",
    )
    parser.add_argument(
        "--output", default="./emonet_output",
        help="Output folder for checkpoints and plots (default: ./emonet_output)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="Learning rate (default: 0.001, as per paper)",
    )
    parser.add_argument(
