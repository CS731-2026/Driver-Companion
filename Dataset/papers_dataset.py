...
# ── Reuse MediaPipe + cleaning helpers from the sibling Dataset.py ──────────
# Loaded by file path to avoid namespace-package ambiguity (this directory
# is also called "Dataset").
_THIS_DIR = Path(__file__).resolve().parent
_spec = importlib.util.spec_from_file_location(
    "_facemesh_base", _THIS_DIR / "Dataset.py"
)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output", default="./facemesh_dataset",
        help="Output dir for .npz files (default: ./facemesh_dataset).",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--model", default=str(_THIS_DIR / "face_landmarker.task"),
        help="Path to face_landmarker.task (default: alongside Dataset.py).",
    )
    parser.add_argument(
